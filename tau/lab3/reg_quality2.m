...
K2 = -double(inv(R + B'*P*B) * B'*P*(A - beta*eye(3)))
e2 = eig(A + B*K2)
ABK2 = A + B*K2 
double(P)
...
hold on
plot(real(e2), imag(e2), "o", "LineWidth", 2)
axis equal
grid on
xlabel("Re")
ylabel("Im")
title("Комплексная плоскость и собственные числа при Q = I, R = 0")
hold off
saveas(gcf, "reg_quality2.png")