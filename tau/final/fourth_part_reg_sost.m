...
x0a_broken = [2.25; 0; 0; 0];
x0dot_a_broken = [0; 2.25; 0; 0];
x0phi_broken = [0; 0; 0.55; 0];
x0dot_phi_broken = [0; 0; 0; 1.85];
...
fprintf('Решение a_broken: все состояния ненулевые [2.25, 0, 0, 0]\n');
[ta_broken, sola_broken] = ode45(@(t,x) nonlinear_pendulum(t, x, K*x, 0, M, m, l, g), 0:dt:1.5, x0a_broken);

fprintf('Решение dot_a_broken: все состояния ненулевые [0, 2.25, 0, 0]\n');
[tdot_a_broken, soldot_a_broken] = ode45(@(t,x) nonlinear_pendulum(t, x, K*x, 0, M, m, l, g), 0:dt:1.4, x0dot_a_broken);

fprintf('Решение phi_broken: все состояния ненулевые [0, 0, 0.55, 0]\n');
[tphi_broken, solphi_broken] = ode45(@(t,x) nonlinear_pendulum(t, x, K*x, 0, M, m, l, g), 0:dt:1.5, x0phi_broken);

fprintf('Решение dot_phi_broken: все состояния ненулевые [0, 0, 0, 1.85]\n');
[tdot_phi_broken, soldot_phi_broken] = ode45(@(t,x) nonlinear_pendulum(t, x, K*x, 0, M, m, l, g), 0:dt:1.6, x0dot_phi_broken);
...
grid on;
xlim([0 4]);
saveas(gcf, 'images/fourth_part_reg_sost_a.png');
...
grid on;
xlim([0 4]);
saveas(gcf, 'images/fourth_part_reg_sost_dot_a.png');
...
grid on;
xlim([0 4]);
saveas(gcf, 'images/fourth_part_reg_sost_phi.png');
...
grid on;
xlim([0 4]);
saveas(gcf, 'images/fourth_part_reg_sost_dot_phi.png');
...
xlabel('t');
ylabel('x');
title('x(t) нелинейной модели при x_0 = [2.25, 0, 0, 0]');
legend('Location', 'northwest');
grid on;
saveas(gcf, 'images/fourth_part_reg_sost_a_broken.png');
...
xlabel('t');
ylabel('x');
title('x(t) нелинейной модели при x_0 = [0, 2.25, 0, 0]');
legend('Location', 'southwest');
grid on;
saveas(gcf, 'images/fourth_part_reg_sost_dot_a_broken.png');
...
xlabel('t');
ylabel('x');
title('x(t) нелинейной модели при x_0 = [0, 0, 0.55, 0]');
legend('Location', 'northwest');
grid on;
saveas(gcf, 'images/fourth_part_reg_sost_phi_broken.png');
...
xlabel('t');
ylabel('x');
title('x(t) нелинейной модели при x_0 = [0, 0, 0, 1.85]');
legend('Location', 'southwest');
grid on;
saveas(gcf, 'images/fourth_part_reg_sost_dot_phi_broken.png');
