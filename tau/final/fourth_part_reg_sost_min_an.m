...
xlabel('t');
ylabel('x');
title('Состояния при \alpha_1 = 0.25 и ограничениях');
legend('Location', 'northeast');
grid on;
xlim([0, 30])
saveas(gcf, 'images/fourth_part_reg_sost_min_an_1.png');

figure;
plot(t1, u1, 'LineWidth', 2, "Clipping", "on");
xlabel('t');
ylabel('u');
title('Управляющее воздействие при \alpha_1 = 0.25 и ограничениях');
grid on;
xlim([0, 30])
saveas(gcf, 'images/fourth_part_reg_sost_min_an_1_u.png');
...
xlabel('t');
ylabel('x');
title('Состояния при \alpha_2 = 0.5 и ограничениях');
legend('Location', 'northeast');
grid on;
xlim([0, 15])
saveas(gcf, 'images/fourth_part_reg_sost_min_an_2.png');

figure;
plot(t2, u2, 'LineWidth', 2, "Clipping", "on");
xlabel('t');
ylabel('u');
title('Управляющее воздействие при \alpha_2 = 0.5 и ограничениях');
grid on;
xlim([0, 15])
saveas(gcf, 'images/fourth_part_reg_sost_min_an_2_u.png');
...
xlabel('t');
ylabel('x');
title('Состояния при \alpha_3 = 1 и ограничениях');
legend('Location', 'northeast');
grid on;
xlim([0, 10])
saveas(gcf, 'images/fourth_part_reg_sost_min_an_3.png');

figure;
plot(t3, u3, 'LineWidth', 2, "Clipping", "on");
xlabel('t');
ylabel('u');
title('Управляющее воздействие при \alpha_3 = 1 и ограничениях');
grid on;
xlim([0, 10])
saveas(gcf, 'images/fourth_part_reg_sost_min_an_3_u.png');
...
xlabel('t');
ylabel('x');
title('Состояния при \alpha_4 = 1.5 и ограничениях');
legend('Location', 'northeast');
grid on;
xlim([0, 5])
saveas(gcf, 'images/fourth_part_reg_sost_min_an_4.png');

figure;
plot(t4, u4, 'LineWidth', 2, "Clipping", "on");
xlabel('t');
ylabel('u');
title('Управляющее воздействие при \alpha_4 = 1.5 и ограничениях');
grid on;
xlim([0, 5])
saveas(gcf, 'images/fourth_part_reg_sost_min_an_4_u.png');
