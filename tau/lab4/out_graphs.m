...
title('Формируемое управление u(t) при z = C_z x + D_z w_g', 'Interpreter', 'tex', 'FontSize', 14);
ylabel('u(t)', 'FontSize', 12);
xlabel('t', 'FontSize', 12);
grid on;
saveas(gcf, fullfile('images', 'out_u_trajectory_cz.png'));
...
hold off;
title('Ошибка оценки при z = C_z x + D_z w_g', 'Interpreter', 'tex', 'FontSize', 14);
...
saveas(gcf, fullfile('images', 'out_error_trajectory_cz.png'));
...
hold on;
plot(out.z, 'LineWidth', 2, 'DisplayName', 'z(t)');
hold off;

title('Выходы y(t) и z(t) при z = C_z x + D_z w_g', 'Interpreter', 'tex', 'FontSize', 14);
ylabel('f(t)', 'FontSize', 12);
xlabel('t', 'FontSize', 12);
grid on;
legend('Location', 'best', 'FontSize', 12);
saveas(gcf, fullfile('images', 'out_phase_trajectories_cz.png'));
...
title('Сравнение x(t) и x̂(t) при z = C_z x + D_z w_g', 'Interpreter', 'tex', 'FontSize', 14);
saveas(gcf, fullfile('images', 'out_states_comparison_cz.png'));
...
title('Сравнение w(t) и ŵ(t) при z = C_z x + D_z w_g', 'Interpreter', 'tex', 'FontSize', 14);
saveas(gcf, fullfile('images', 'out_disturbances_comparison_cz.png'));
