...
xlabel('t');
grid on;
saveas(gcf, fullfile('images', 'comp_sost_z_feedback.png'));
...
saveas(gcf, fullfile('images', 'comp_sost_x_feedback.png'));
...
xlabel('t');
grid on;
saveas(gcf, fullfile('images', 'comp_sost_u_feedback.png'));