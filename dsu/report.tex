...
\begin{document}
	...
	Нейтральная граница $|z| = 1$, колебательная $z = - 1$. Таким образом, колебатльная граница - частный случай нейтральной.
	...
	Оптимальное по быстродействию значение $z = 0$. Но она физически нереализуема, так как при уменьшении $T$ (стремлении к непрерывной системе), так как в этом случае необходимо обеспечить бесконечно большой коэффициент $K_{FB}$ цифрового регулятора, что в реальности, конечно же, неосуществимо.
