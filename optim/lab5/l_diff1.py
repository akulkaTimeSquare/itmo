...
plt.figure()
plt.plot(t_values, e_h1_new_list, label='$e_{H1}$', color='red')
plt.title(f'Ошибка $e_{{H1}}$ с измененной матрицей L')
plt.grid(True)
plt.xlabel("t")
plt.ylabel("$e_{H1}(t)$")
plt.legend()
plt.savefig('images/eh1_suboptimal1.png')

plt.figure()
plt.plot(t_values, e_h2_new_list, label='$e_{H2}$', color='red')
plt.title(f'Ошибка $e_{{H2}}$ с измененной матрицей L')
plt.xlabel("t")
plt.ylabel("$e_{H2}(t)$")
plt.grid(True)
plt.legend()
plt.savefig('images/eh2_suboptimal1.png')

plt.figure()
plt.plot(t_values, J_new_list, label='$J(t)$', color='red')
plt.title('Критерий $J(t)$ с измененной матрицей L')
plt.grid(True)
plt.legend()
plt.xlabel("t")
plt.ylabel("$J(t)$")
plt.savefig('images/j_suboptimal1.png')
