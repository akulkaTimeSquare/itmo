...
plt.xlabel('t')
plt.ylabel('x(t)')
plt.title('Состояния объекта и эталонной модели при сильном отклонении параметров')
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.xlim(t_span[0], t_span[1])
plt.savefig('images/3_unknown_params_response_unstable.png', dpi=450)
plt.show()
...
plt.xlabel('t')
plt.ylabel('e(t)')
plt.title('Ошибка между объектом и эталоном при сильном отклонении параметров')
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.xlim(t_span[0], t_span[1])
plt.savefig('images/3_unknown_params_error_unstable.png', dpi=450)
plt.show()
...
plt.title(r'Ошибка оценки $\tilde{\theta}(t)$ при сильном отклонении параметров')
plt.grid(True)
plt.legend()
plt.tight_layout()
plt.xlim(t_span[0], t_span[1])
plt.savefig('images/3_unknown_params_estimation_unstable.png', dpi=450)
plt.show()