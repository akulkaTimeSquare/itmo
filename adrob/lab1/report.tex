...
\begin{document}
	...
	\section{Цель работы}
	Освоение принципов построения адаптивной системы управления многомерным объектом с использованием эталонной модели.
	...
	Повторим всё проделанное в предыдущем пункте, но уже с алгоритмом адаптации, то есть примем новые матрицы:
	\[
		A = \begin{bmatrix}
			0 & 1 \\
			0 & 0
	...
	Получаются эксперименты с расчетными параметрами объекта, а также при небольшом и сильном их отклонении. Итак, для них замоделируем динамику с вышеприведенным в пункте управлением и условиями $x(0)$, $x_M(0)$. Все графики приведены на рисунках \ref{fig:3_known_params_response} - \ref{fig:3_unknown_params_estimation_unstable}.
