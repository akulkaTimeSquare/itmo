...
title('Оценка a_1 при u = sin(\omegat) + 0.2sin(0.5\omegat)');
yticks([a1 -1 0])
xlabel("t")
ylabel("\theta(t)")
ylim([-2 0.1])
...
title('Оценка a_2 при u = sin(\omegat) + 0.2sin(0.5\omegat)');
yticks([0 0.5 a2])
xlabel("t")
ylabel("\theta(t)")
ylim([-0.1 1]);
...
title('Оценка b при u = sin(\omegat) + 0.2sin(0.5\omegat)');
ylim([-0.2 2.7])
yticks([0 1 2 b])
xlabel("t")
ylabel("\theta(t)")
saveas(gcf, "images/task2_3.png")
